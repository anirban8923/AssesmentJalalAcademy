...
public class ExtentReport 
{
	...
	{		
		...
		spark.config().setDocumentTitle(" Automation Regression Suite");
		extentReports.attachReporter(spark);
		extentReports.setSystemInfo("Project Name", "JalalAcademy");
		extentReports.setSystemInfo("Version", "JalalAcademy 1.0");
	}
